...
<head>
	<meta charset="utf-8" />
	<title>&gt;arg&iexcl;eBarg!e: Flexigrid-S</title>
	<meta name="description" content="&hellip;extensions to the jQuery table plugin." />
...
<body lang="en">
    	...
    	<header>
        	<div style="float:right">
				<a href="https://github.com/hhrogersii/argleBargle/tree/master/flexigrid-s/"><img id="octodex" src="/img/octodex.png" width="24" height="24" alt="Git'er Done" /></a>  &larr;
	 			<a href="http://hhrogersii.com/lab/flexigrid-s/">Flexigrid-S</a> &larr; 
    ...
    <article>
        ...
        <header>
        	<h2>Flexigrid-S</h2>
        	<p>&hellip;extensions to the jQuery table plugin.</p>
        </header>
